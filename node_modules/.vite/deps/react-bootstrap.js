...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/querySelectorAll.js
var toArray = Function.prototype.bind.call(Function.prototype.call, [].slice);
function qsa(element, selector) {
  return toArray(element.querySelectorAll(selector));
}

// node_modules/@restart/ui/node_modules/dom-helpers/esm/canUseDOM.js
var canUseDOM_default2 = !!(typeof window !== "undefined" && window.document && window.document.createElement);

// node_modules/@restart/ui/node_modules/dom-helpers/esm/addEventListener.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/contains.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/removeEventListener.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/listen.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/ownerDocument.js
...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  (0, import_react38.useEffect)(() => {
    ...
    const ownerWindow3 = doc.defaultView || window;
    let currentEvent = (_ownerWindow$event = ownerWindow3.event) != null ? _ownerWindow$event : (_ownerWindow$parent = ownerWindow3.parent) == null ? void 0 : _ownerWindow$parent.event;
    let removeInitialTriggerListener = null;
    if (InitialTriggerEvents[clickTrigger]) {
      removeInitialTriggerListener = listen_default2(doc, InitialTriggerEvents[clickTrigger], handleInitialMouse, true);
    }
    const removeMouseCaptureListener = listen_default2(doc, clickTrigger, handleMouseCapture, true);
    const removeMouseListener = listen_default2(doc, clickTrigger, (e) => {
      if (e === currentEvent) {
        currentEvent = void 0;
        return;
      }
    ...
    if ("ontouchstart" in doc.documentElement) {
      mobileSafariHackListeners = [].slice.call(doc.body.children).map((el) => listen_default2(el, "mousemove", noop2));
    }
    return () => {
...
var Context = (0, import_react43.createContext)(canUseDOM_default2 ? window : void 0);
  ...
  useEventListener((0, import_react44.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
    ...
    switch (key) {
      ...
      case "ArrowDown":
        ...
        return;
      case "Tab":
        addEventListener_default2(target.ownerDocument, "keyup", (e) => {
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/activeElement.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/ownerWindow.js
function ownerWindow2(node) {
  var doc = ownerDocument2(node);
  return doc && doc.defaultView || window;
}

// node_modules/@restart/ui/node_modules/dom-helpers/esm/getComputedStyle.js
function getComputedStyle4(node, psuedoElement) {
  return ownerWindow2(node).getComputedStyle(node, psuedoElement);
}

// node_modules/@restart/ui/node_modules/dom-helpers/esm/hyphenate.js
var rUpper2 = /([A-Z])/g;
function hyphenate2(string) {
  return string.replace(rUpper2, "-$1").toLowerCase();
}

// node_modules/@restart/ui/node_modules/dom-helpers/esm/hyphenateStyle.js
var msPattern2 = /^ms-/;
function hyphenateStyleName2(string) {
  return hyphenate2(string).replace(msPattern2, "-ms-");
}

// node_modules/@restart/ui/node_modules/dom-helpers/esm/isTransform.js
...
// node_modules/@restart/ui/node_modules/dom-helpers/esm/css.js
function style2(node, property) {
  var css = "";
  var transforms = "";
  if (typeof property === "string") {
    return node.style.getPropertyValue(hyphenateStyleName2(property)) || getComputedStyle4(node).getPropertyValue(hyphenateStyleName2(property));
  }
  Object.keys(property).forEach(function(key) {
    var value = property[key];
    if (!value && value !== 0) {
...
var ModalManager = class {
  ...
  setContainerStyle(containerState) {
    ...
    if (containerState.scrollBarWidth) {
      style3[paddingProp] = `${parseInt(css_default2(container, paddingProp) || "0", 10) + containerState.scrollBarWidth}px`;
    }
...
var resolveContainerRef = (ref, document2) => {
  if (!canUseDOM_default2)
    return null;
  if (ref == null)
    return (document2 || ownerDocument2()).body;
...
var Modal = (0, import_react63.forwardRef)((_ref, ref) => {
  ...
  if (canUseDOM_default2 && !prevShow && show) {
    lastFocusRef.current = activeElement(ownerWindow3 == null ? void 0 : ownerWindow3.document);
  }
  if (show && exited) {
    setExited(false);
  }
  const handleShow = useEventCallback(() => {
    modal.add();
    removeKeydownListenerRef.current = listen_default2(document, "keydown", handleDocumentKeyDown);
    removeFocusListenerRef.current = listen_default2(
      document,
      "focus",
    ...
    if (autoFocus) {
      ...
      const currentActiveElement = activeElement((_modal$dialog$ownerDo = (_modal$dialog = modal.dialog) == null ? void 0 : _modal$dialog.ownerDocument) != null ? _modal$dialog$ownerDo : ownerWindow3 == null ? void 0 : ownerWindow3.document);
  ...
  const handleEnforceFocus = useEventCallback(() => {
    ...
    const currentActiveElement = activeElement(ownerWindow3 == null ? void 0 : ownerWindow3.document);
    if (modal.dialog && currentActiveElement && !contains2(modal.dialog, currentActiveElement)) {
      modal.dialog.focus();
    }
  });
...
// node_modules/react-bootstrap/node_modules/dom-helpers/esm/addClass.js
...
// node_modules/react-bootstrap/node_modules/dom-helpers/esm/removeClass.js
...
function useRootClose(ref, onRootClose, {
  ...
  (0, import_react74.useEffect)(() => {
    ...
    const removeKeyupListener = listen_default2(doc, "keyup", (e) => {
      if (e === currentEvent) {
        currentEvent = void 0;
        return;
      }
...
function contains3(context6, node) {
  if (context6.contains)
    return context6.contains(node);
  if (context6.compareDocumentPosition)
    return context6 === node || !!(context6.compareDocumentPosition(node) & 16);
