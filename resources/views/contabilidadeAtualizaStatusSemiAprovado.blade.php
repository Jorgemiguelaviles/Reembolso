    ...
    <table class="container" width="600" cellpadding="0" cellspacing="0" border="0" align="center" style="margin: 0 auto; background-color: #ffffff; border-collapse: collapse;">
        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="font-size: 16px; line-height: 1.5; color: #666666;">A solicitação do {{ $usuario }} foi pré-aprovada com sucesso.</p>
                <p style="font-size: 16px; line-height: 1.5; color: #666666;">Favor verificar.</p>
