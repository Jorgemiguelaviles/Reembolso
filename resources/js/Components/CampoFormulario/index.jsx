...
const CampoFormulario = ({
    ...
    const showNotificationWithTimeout = (message, duration) => {
        setMsg(message);
    ...
    const handleSubmit = () => {
        ...
        const rotaBack = `${domain}solicitacao`;
        enviarDadosParaBackend(rotaBack, dados, listfile)
            .then(mensagem => {
    ...
    const handleFileChange = (index, event) => {
        ...
        if (file && allowedTypes.includes(file.type)) {
            ...
            showNotificationWithTimeout(<span style={{ color: 'blue', fontWeight: 'bold' }}>Arquivo foi enviado com sucesso.</span>, 3000);
        } else {
            showNotificationWithTimeout("Formato do arquivo inválido.", 3000);
        }
    };
